        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-center md:justify-end gap-8">
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+19494096450" className="text-xl font-bold text-black hover:text-secondary transition-colors">
                (949) 409-6450
              </a>
            </div>
            <div className="flex items-center gap-2">
              <Mail className="h-5 w-5 text-secondary" />
              <a href="mailto:fixrighthandyman@gmail.com" className="text-black hover:text-secondary">
